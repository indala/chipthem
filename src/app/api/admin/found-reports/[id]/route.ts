...
export async function DELETE(
  ...
  try {
    ...
    if (fetchError && fetchError.code !== "PGRST116") {
      console.error("Error fetching found report to delete:", fetchError);
    ...
    // 3️⃣ Delete the record from database
    ...
    if (deleteError) {
      console.error("Error deleting found report from database:", deleteError);
    ...
    console.error("Error in DELETE /api/admin/found-reports/[id]:", error);
    return NextResponse.json(
