...
var require_middleware = __commonJS({
  ".next/server/src/middleware.js"() {
    ...
    (self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([[550], { 521: (e) => {
      ...
      "use strict";
      r.r(t), r.d(t, { DiagConsoleLogger: () => L, DiagLogLevel: () => n, INVALID_SPANID: () => ed, INVALID_SPAN_CONTEXT: () => eh, INVALID_TRACEID: () => ep, ProxyTracer: () => eO, ProxyTracerProvider: () => eI, ROOT_CONTEXT: () => N, SamplingDecision: () => a, SpanKind: () => s, SpanStatusCode: () => l, TraceFlags: () => o, ValueType: () => i, baggageEntryMetadataFromString: () => A, context: () => eH, createContextKey: () => O, createNoopMeter: () => ee, createTraceState: () => eU, default: () => e2, defaultTextMapGetter: () => et, defaultTextMapSetter: () => er, diag: () => eW, isSpanContextValid: () => eR, isValidSpanId: () => eC, isValidTraceId: () => eE, metrics: () => eB, propagation: () => eZ, trace: () => e1 });
      ...
      var eT = eu.getInstance(), eP = function() {
        function e3() {
        }
        ...
        return e3.prototype.startSpan = function(e4, t2, r2) {
          ...
          return e4 ? (this._delegate = e4, this._delegate) : eA;
        }, e3;
      }(), eN = new (function() {
        function e3() {
        }
      ...
      var eQ = "propagation", eY = new eJ(), eZ = function() {
        function e3() {
          this.createBaggage = P, this.getBaggage = eV, this.getActiveBaggage = eF, this.setBaggage = eG, this.deleteBaggage = eX;
        }
        return e3.getInstance = function() {
          return this._instance || (this._instance = new e3()), this._instance;
      ...
      (() => {
        var i = { 226: function(i2, o2) {
          !function(a2, s2) {
            "use strict";
            var l = "function", c = "undefined", u = "object", d = "string", p = "major", h = "model", f = "name", g = "type", m = "vendor", y = "version", w = "architecture", v = "console", b = "mobile", S = "tablet", _ = "smarttv", x = "wearable", E = "embedded", C = "Amazon", R = "Apple", k = "ASUS", T = "BlackBerry", P = "Browser", A = "Chrome", O = "Firefox", N = "Google", I = "Huawei", L = "Microsoft", M = "Motorola", j = "Opera", D = "Samsung", q = "Sharp", U = "Sony", H = "Xiaomi", W = "Zebra", K = "Facebook", $ = "Chromium OS", B = "Mac OS", J = function(e2, t2) {
              var r2 = {};
...
Learn More: https://nextjs.org/docs/messages/node-module-in-edge-runtime`;
  ...
  `);
      ...
      class L {
        ...
        analyze() {
          ...
          let o2 = function(e11, t3) {
            ...
            if (o3) {
              let e12 = t3.i18nProvider ? t3.i18nProvider.analyze(s3.pathname) : A(s3.pathname, o3.locales);
              s3.locale = e12.detectedLocale, s3.pathname = null != (n3 = e12.pathname) ? n3 : s3.pathname, !e12.detectedLocale && s3.buildId && (e12 = t3.i18nProvider ? t3.i18nProvider.analyze(l2) : A(l2, o3.locales)).detectedLocale && (s3.locale = e12.detectedLocale);
            }
            return s3;
        ...
        formatPathname() {
          ...
          return t2 = function(e11, t3, r2, n2) {
            ...
            return !n2 && (P(i2, "/api") || P(i2, "/" + t3.toLowerCase())) ? e11 : k(e11, "/" + t3);
      ...
      }, eA = /* @__PURE__ */ new Map(), eO = n.createContextKey("next.rootSpanId"), eN = 0, eI = () => eN++, eL = { set(e10, t2, r2) {
      ...
      class eM {
        ...
        trace(...e10) {
          ...
          return a2.attributes = { "next.span_name": s2, "next.span_type": r2, ...a2.attributes }, e_.with(l2.setValue(eO, u2), () => this.getTracerInstance().startActiveSpan(s2, a2, (e11) => {
            let t3 = "performance" in globalThis && "measure" in performance ? globalThis.performance.now() : void 0, n3 = () => {
              eA.delete(u2), t3 && process.env.NEXT_OTEL_PERFORMANCE_PREFIX && eb.includes(r2 || "") && performance.measure(`${process.env.NEXT_OTEL_PERFORMANCE_PREFIX}:next-${(r2.split(".").pop() || "").replace(/[A-Z]/g, (e12) => "-" + e12.toLowerCase())}`, { start: t3, end: performance.now() });
            };
            c2 && eA.set(u2, new Map(Object.entries(a2.attributes ?? {})));
            try {
        ...
        setRootSpanAttribute(e10, t2) {
          let r2 = e_.active().getValue(eO), n2 = eA.get(r2);
          n2 && n2.set(e10, t2);
        }
      }
      let ej = (() => {
      ...
      let e2 = { keys: (e10) => Array.from(e10.keys()), get: (e10, t2) => e10.get(t2) ?? void 0 }, e5 = (e10, t2) => ej().withPropagatedContext(e10.headers, t2, e2), e3 = false;
      ...
      async function tM(e10, t2, r2) {
        ...
        let a2 = { ...o2, ...e10.header }, s2 = tP(ti, /* @__PURE__ */ new Map([["b64", true]]), r2?.crit, o2, a2), l2 = true;
        ...
        let u2 = r2 && tA("algorithms", r2.algorithms);
      ...
      async function t$(e10) {
        ...
        if ("/unauthorized" === n2 || n2.startsWith("/_next/") || "/favicon.ico" === n2 || n2.startsWith("/api/auth/") || "/api/pet/login" === n2 || "/api/pet/register" === n2 || "/api/veterinary/login" === n2 || "/api/veterinary/register" === n2 || "/api/admin/login" === n2) return K.next();
        let i2 = [{ role: "admin", prefix: "/admin", apiPrefix: "/api/admin", cookieName: "admin_token", loginPath: "/alogin", dashboardPath: "/admin/dashboard" }, { role: "veterinary", prefix: "/veterinary", apiPrefix: "/api/veterinary", cookieName: "veterinary_token", loginPath: "/vlogin", dashboardPath: "/veterinary/dashboard" }, { role: "petOwner", prefix: "/petOwner", apiPrefix: "/api/owner", cookieName: "petOwner_token", loginPath: "/pologin", dashboardPath: "/petOwner/dashboard" }].find((e11) => n2.startsWith(e11.prefix) || n2.startsWith(e11.apiPrefix) || n2 === e11.loginPath);
        if (!i2) return K.next();
        let { cookieName: o2, loginPath: a2, dashboardPath: s2, role: l2, prefix: c2, apiPrefix: u2 } = i2, d2 = e10.cookies.get(o2)?.value;
        if (n2 === a2 && d2) try {
          let { payload: t3 } = await tK(d2, r2);
          if (t3.role === l2) return K.redirect(new URL(s2, e10.url));
        } catch {
          let e11 = K.next();
          return e11.cookies.delete(o2), e11;
        }
        if (n2.startsWith(c2) || n2.startsWith(u2)) {
          if (!d2) return K.redirect(new URL(a2, e10.url));
          try {
            let { payload: t3 } = await tK(d2, r2);
            if (t3.role !== l2) {
              let t4 = K.redirect(new URL("/unauthorized", e10.url));
              return t4.cookies.delete(o2), t4;
            }
            return K.next();
          } catch {
      ...
      let tB = { matcher: ["/admin/:path*", "/veterinary/:path*", "/petOwner/:path*", "/api/admin/:path*", "/api/veterinary/:path*", "/api/owner/:path*", "/alogin", "/vlogin", "/pologin", "/unauthorized"] };
...
var init_edgeFunctionHandler = __esm({
  "node_modules/.pnpm/@opennextjs+aws@3.8.5/node_modules/@opennextjs/aws/dist/core/edgeFunctionHandler.js"() {
    ...
    globalThis._ROUTES = [{ "name": "src/middleware", "page": "/", "regex": ["^(?:\\/(_next\\/data\\/[^/]{1,}))?\\/admin(?:\\/((?:[^\\/#\\?]+?)(?:\\/(?:[^\\/#\\?]+?))*))?(\\.json)?[\\/#\\?]?$", "^(?:\\/(_next\\/data\\/[^/]{1,}))?\\/veterinary(?:\\/((?:[^\\/#\\?]+?)(?:\\/(?:[^\\/#\\?]+?))*))?(\\.json)?[\\/#\\?]?$", "^(?:\\/(_next\\/data\\/[^/]{1,}))?\\/petOwner(?:\\/((?:[^\\/#\\?]+?)(?:\\/(?:[^\\/#\\?]+?))*))?(\\.json)?[\\/#\\?]?$", "^(?:\\/(_next\\/data\\/[^/]{1,}))?\\/api\\/admin(?:\\/((?:[^\\/#\\?]+?)(?:\\/(?:[^\\/#\\?]+?))*))?(\\.json)?[\\/#\\?]?$", "^(?:\\/(_next\\/data\\/[^/]{1,}))?\\/api\\/veterinary(?:\\/((?:[^\\/#\\?]+?)(?:\\/(?:[^\\/#\\?]+?))*))?(\\.json)?[\\/#\\?]?$", "^(?:\\/(_next\\/data\\/[^/]{1,}))?\\/api\\/owner(?:\\/((?:[^\\/#\\?]+?)(?:\\/(?:[^\\/#\\?]+?))*))?(\\.json)?[\\/#\\?]?$", "^(?:\\/(_next\\/data\\/[^/]{1,}))?\\/alogin(\\.json)?[\\/#\\?]?$", "^(?:\\/(_next\\/data\\/[^/]{1,}))?\\/vlogin(\\.json)?[\\/#\\?]?$", "^(?:\\/(_next\\/data\\/[^/]{1,}))?\\/pologin(\\.json)?[\\/#\\?]?$", "^(?:\\/(_next\\/data\\/[^/]{1,}))?\\/unauthorized(\\.json)?[\\/#\\?]?$"] }];
...
var NextConfig = { "env": {}, "eslint": { "ignoreDuringBuilds": false }, "typescript": { "ignoreBuildErrors": false, "tsconfigPath": "tsconfig.json" }, "distDir": ".next", "cleanDistDir": true, "assetPrefix": "", "cacheMaxMemorySize": 52428800, "configOrigin": "next.config.ts", "useFileSystemPublicRoutes": true, "generateEtags": true, "pageExtensions": ["tsx", "ts", "jsx", "js"], "poweredByHeader": true, "compress": true, "images": { "deviceSizes": [640, 750, 828, 1080, 1200, 1920, 2048, 3840], "imageSizes": [16, 32, 48, 64, 96, 128, 256, 384], "path": "/_next/image", "loader": "default", "loaderFile": "", "domains": [], "disableStaticImages": false, "minimumCacheTTL": 60, "formats": ["image/webp"], "dangerouslyAllowSVG": false, "contentSecurityPolicy": "script-src 'none'; frame-src 'none'; sandbox;", "contentDispositionType": "attachment", "remotePatterns": [{ "protocol": "https", "hostname": "zwqngfcujvsaahykqisj.supabase.co", "port": "", "pathname": "/storage/v1/object/public/**" }], "unoptimized": false }, "devIndicators": { "appIsrStatus": true, "buildActivity": true, "buildActivityPosition": "bottom-right" }, "onDemandEntries": { "maxInactiveAge": 6e4, "pagesBufferLength": 5 }, "amp": { "canonicalBase": "" }, "basePath": "", "sassOptions": {}, "trailingSlash": false, "i18n": null, "productionBrowserSourceMaps": false, "excludeDefaultMomentLocales": true, "serverRuntimeConfig": {}, "publicRuntimeConfig": {}, "reactProductionProfiling": false, "reactStrictMode": null, "reactMaxHeadersLength": 6e3, "httpAgentOptions": { "keepAlive": true }, "logging": {}, "expireTime": 31536e3, "staticPageGenerationTimeout": 60, "output": "standalone", "modularizeImports": { "@mui/icons-material": { "transform": "@mui/icons-material/{{member}}" }, "lodash": { "transform": "lodash/{{member}}" } }, "outputFileTracingRoot": "/home/chinnu/projects/chipthem", "experimental": { "cacheLife": { "default": { "stale": 300, "revalidate": 900, "expire": 4294967294 }, "seconds": { "stale": 0, "revalidate": 1, "expire": 60 }, "minutes": { "stale": 300, "revalidate": 60, "expire": 3600 }, "hours": { "stale": 300, "revalidate": 3600, "expire": 86400 }, "days": { "stale": 300, "revalidate": 86400, "expire": 604800 }, "weeks": { "stale": 300, "revalidate": 604800, "expire": 2592e3 }, "max": { "stale": 300, "revalidate": 2592e3, "expire": 4294967294 } }, "cacheHandlers": {}, "cssChunking": true, "multiZoneDraftMode": false, "appNavFailHandling": false, "prerenderEarlyExit": true, "serverMinification": true, "serverSourceMaps": false, "linkNoTouchStart": false, "caseSensitiveRoutes": false, "clientSegmentCache": false, "preloadEntriesOnStart": true, "clientRouterFilter": true, "clientRouterFilterRedirects": false, "fetchCacheKeyPrefix": "", "middlewarePrefetch": "flexible", "optimisticClientCache": true, "manualClientBasePath": false, "cpus": 15, "memoryBasedWorkersCount": false, "imgOptConcurrency": null, "imgOptTimeoutInSeconds": 7, "imgOptMaxInputPixels": 268402689, "imgOptSequentialRead": null, "isrFlushToDisk": true, "workerThreads": false, "optimizeCss": false, "nextScriptWorkers": false, "scrollRestoration": false, "externalDir": false, "disableOptimizedLoading": false, "gzipSize": true, "craCompat": false, "esmExternals": true, "fullySpecified": false, "swcTraceProfiling": false, "forceSwcTransforms": false, "largePageDataBytes": 128e3, "turbo": { "root": "/home/chinnu/projects/chipthem" }, "typedRoutes": false, "typedEnv": false, "parallelServerCompiles": false, "parallelServerBuildTraces": false, "ppr": false, "authInterrupts": false, "reactOwnerStack": false, "webpackMemoryOptimizations": false, "optimizeServerReact": true, "useEarlyImport": false, "staleTimes": { "dynamic": 0, "static": 300 }, "serverComponentsHmrCache": true, "staticGenerationMaxConcurrency": 8, "staticGenerationMinPagesPerWorker": 25, "dynamicIO": false, "inlineCss": false, "optimizePackageImports": ["lucide-react", "date-fns", "lodash-es", "ramda", "antd", "react-bootstrap", "ahooks", "@ant-design/icons", "@headlessui/react", "@headlessui-float/react", "@heroicons/react/20/solid", "@heroicons/react/24/solid", "@heroicons/react/24/outline", "@visx/visx", "@tremor/react", "rxjs", "@mui/material", "@mui/icons-material", "recharts", "react-use", "effect", "@effect/schema", "@effect/platform", "@effect/platform-node", "@effect/platform-browser", "@effect/platform-bun", "@effect/sql", "@effect/sql-mssql", "@effect/sql-mysql2", "@effect/sql-pg", "@effect/sql-squlite-node", "@effect/sql-squlite-bun", "@effect/sql-squlite-wasm", "@effect/sql-squlite-react-native", "@effect/rpc", "@effect/rpc-http", "@effect/typeclass", "@effect/experimental", "@effect/opentelemetry", "@material-ui/core", "@material-ui/icons", "@tabler/icons-react", "mui-core", "react-icons/ai", "react-icons/bi", "react-icons/bs", "react-icons/cg", "react-icons/ci", "react-icons/di", "react-icons/fa", "react-icons/fa6", "react-icons/fc", "react-icons/fi", "react-icons/gi", "react-icons/go", "react-icons/gr", "react-icons/hi", "react-icons/hi2", "react-icons/im", "react-icons/io", "react-icons/io5", "react-icons/lia", "react-icons/lib", "react-icons/lu", "react-icons/md", "react-icons/pi", "react-icons/ri", "react-icons/rx", "react-icons/si", "react-icons/sl", "react-icons/tb", "react-icons/tfi", "react-icons/ti", "react-icons/vsc", "react-icons/wi"], "trustHostHeader": false, "isExperimentalCompile": false }, "bundlePagesRouterDependencies": false, "configFileName": "next.config.ts" };
var BuildId = "CDEiWxBtVXq-MrnvDW5dM";
var RoutesManifest = { "basePath": "", "rewrites": { "beforeFiles": [], "afterFiles": [], "fallback": [] }, "redirects": [{ "source": "/:path+/", "destination": "/:path+", "internal": true, "statusCode": 308, "regex": "^(?:/((?:[^/]+?)(?:/(?:[^/]+?))*))/$" }], "routes": { "static": [{ "page": "/", "regex": "^/(?:/)?$", "routeKeys": {}, "namedRegex": "^/(?:/)?$" }, { "page": "/_not-found", "regex": "^/_not\\-found(?:/)?$", "routeKeys": {}, "namedRegex": "^/_not\\-found(?:/)?$" }, { "page": "/about", "regex": "^/about(?:/)?$", "routeKeys": {}, "namedRegex": "^/about(?:/)?$" }, { "page": "/admin/analytics", "regex": "^/admin/analytics(?:/)?$", "routeKeys": {}, "namedRegex": "^/admin/analytics(?:/)?$" }, { "page": "/admin/dashboard", "regex": "^/admin/dashboard(?:/)?$", "routeKeys": {}, "namedRegex": "^/admin/dashboard(?:/)?$" }, { "page": "/admin/lost-found", "regex": "^/admin/lost\\-found(?:/)?$", "routeKeys": {}, "namedRegex": "^/admin/lost\\-found(?:/)?$" }, { "page": "/admin/manage-users", "regex": "^/admin/manage\\-users(?:/)?$", "routeKeys": {}, "namedRegex": "^/admin/manage\\-users(?:/)?$" }, { "page": "/admin/profile", "regex": "^/admin/profile(?:/)?$", "routeKeys": {}, "namedRegex": "^/admin/profile(?:/)?$" }, { "page": "/admin/verifications/petOwner", "regex": "^/admin/verifications/petOwner(?:/)?$", "routeKeys": {}, "namedRegex": "^/admin/verifications/petOwner(?:/)?$" }, { "page": "/admin/verifications/veterinary", "regex": "^/admin/verifications/veterinary(?:/)?$", "routeKeys": {}, "namedRegex": "^/admin/verifications/veterinary(?:/)?$" }, { "page": "/alogin", "regex": "^/alogin(?:/)?$", "routeKeys": {}, "namedRegex": "^/alogin(?:/)?$" }, { "page": "/contact", "regex": "^/contact(?:/)?$", "routeKeys": {}, "namedRegex": "^/contact(?:/)?$" }, { "page": "/favicon.ico", "regex": "^/favicon\\.ico(?:/)?$", "routeKeys": {}, "namedRegex": "^/favicon\\.ico(?:/)?$" }, { "page": "/findclinic", "regex": "^/findclinic(?:/)?$", "routeKeys": {}, "namedRegex": "^/findclinic(?:/)?$" }, { "page": "/forgot-password", "regex": "^/forgot\\-password(?:/)?$", "routeKeys": {}, "namedRegex": "^/forgot\\-password(?:/)?$" }, { "page": "/getpetmicrochipped", "regex": "^/getpetmicrochipped(?:/)?$", "routeKeys": {}, "namedRegex": "^/getpetmicrochipped(?:/)?$" }, { "page": "/lostfound", "regex": "^/lostfound(?:/)?$", "routeKeys": {}, "namedRegex": "^/lostfound(?:/)?$" }, { "page": "/petOwner/dashboard", "regex": "^/petOwner/dashboard(?:/)?$", "routeKeys": {}, "namedRegex": "^/petOwner/dashboard(?:/)?$" }, { "page": "/petOwner/my-pets", "regex": "^/petOwner/my\\-pets(?:/)?$", "routeKeys": {}, "namedRegex": "^/petOwner/my\\-pets(?:/)?$" }, { "page": "/petOwner/profile", "regex": "^/petOwner/profile(?:/)?$", "routeKeys": {}, "namedRegex": "^/petOwner/profile(?:/)?$" }, { "page": "/petOwner/settings", "regex": "^/petOwner/settings(?:/)?$", "routeKeys": {}, "namedRegex": "^/petOwner/settings(?:/)?$" }, { "page": "/pologin", "regex": "^/pologin(?:/)?$", "routeKeys": {}, "namedRegex": "^/pologin(?:/)?$" }, { "page": "/practice", "regex": "^/practice(?:/)?$", "routeKeys": {}, "namedRegex": "^/practice(?:/)?$" }, { "page": "/privacy", "regex": "^/privacy(?:/)?$", "routeKeys": {}, "namedRegex": "^/privacy(?:/)?$" }, { "page": "/registerpet", "regex": "^/registerpet(?:/)?$", "routeKeys": {}, "namedRegex": "^/registerpet(?:/)?$" }, { "page": "/registersuccesspet", "regex": "^/registersuccesspet(?:/)?$", "routeKeys": {}, "namedRegex": "^/registersuccesspet(?:/)?$" }, { "page": "/registersuccessvet", "regex": "^/registersuccessvet(?:/)?$", "routeKeys": {}, "namedRegex": "^/registersuccessvet(?:/)?$" }, { "page": "/reset-password", "regex": "^/reset\\-password(?:/)?$", "routeKeys": {}, "namedRegex": "^/reset\\-password(?:/)?$" }, { "page": "/search", "regex": "^/search(?:/)?$", "routeKeys": {}, "namedRegex": "^/search(?:/)?$" }, { "page": "/successstories", "regex": "^/successstories(?:/)?$", "routeKeys": {}, "namedRegex": "^/successstories(?:/)?$" }, { "page": "/terms", "regex": "^/terms(?:/)?$", "routeKeys": {}, "namedRegex": "^/terms(?:/)?$" }, { "page": "/veterinary/dashboard", "regex": "^/veterinary/dashboard(?:/)?$", "routeKeys": {}, "namedRegex": "^/veterinary/dashboard(?:/)?$" }, { "page": "/veterinary/my-clinic", "regex": "^/veterinary/my\\-clinic(?:/)?$", "routeKeys": {}, "namedRegex": "^/veterinary/my\\-clinic(?:/)?$" }, { "page": "/veterinary/profile", "regex": "^/veterinary/profile(?:/)?$", "routeKeys": {}, "namedRegex": "^/veterinary/profile(?:/)?$" }, { "page": "/veterinary/settings", "regex": "^/veterinary/settings(?:/)?$", "routeKeys": {}, "namedRegex": "^/veterinary/settings(?:/)?$" }, { "page": "/vetregister", "regex": "^/vetregister(?:/)?$", "routeKeys": {}, "namedRegex": "^/vetregister(?:/)?$" }, { "page": "/vlogin", "regex": "^/vlogin(?:/)?$", "routeKeys": {}, "namedRegex": "^/vlogin(?:/)?$" }], "dynamic": [{ "page": "/api/admin/found-reports/[id]", "regex": "^/api/admin/found\\-reports/([^/]+?)(?:/)?$", "routeKeys": { "nxtPid": "nxtPid" }, "namedRegex": "^/api/admin/found\\-reports/(?<nxtPid>[^/]+?)(?:/)?$" }, { "page": "/api/admin/found-reports/[id]/resolve", "regex": "^/api/admin/found\\-reports/([^/]+?)/resolve(?:/)?$", "routeKeys": { "nxtPid": "nxtPid" }, "namedRegex": "^/api/admin/found\\-reports/(?<nxtPid>[^/]+?)/resolve(?:/)?$" }, { "page": "/api/admin/lost-reports/[id]", "regex": "^/api/admin/lost\\-reports/([^/]+?)(?:/)?$", "routeKeys": { "nxtPid": "nxtPid" }, "namedRegex": "^/api/admin/lost\\-reports/(?<nxtPid>[^/]+?)(?:/)?$" }, { "page": "/api/admin/lost-reports/[id]/resolve", "regex": "^/api/admin/lost\\-reports/([^/]+?)/resolve(?:/)?$", "routeKeys": { "nxtPid": "nxtPid" }, "namedRegex": "^/api/admin/lost\\-reports/(?<nxtPid>[^/]+?)/resolve(?:/)?$" }, { "page": "/api/admin/pets/[ownerId]/[petId]/reject", "regex": "^/api/admin/pets/([^/]+?)/([^/]+?)/reject(?:/)?$", "routeKeys": { "nxtPownerId": "nxtPownerId", "nxtPpetId": "nxtPpetId" }, "namedRegex": "^/api/admin/pets/(?<nxtPownerId>[^/]+?)/(?<nxtPpetId>[^/]+?)/reject(?:/)?$" }, { "page": "/api/admin/pets/[ownerId]/[petId]/verify", "regex": "^/api/admin/pets/([^/]+?)/([^/]+?)/verify(?:/)?$", "routeKeys": { "nxtPownerId": "nxtPownerId", "nxtPpetId": "nxtPpetId" }, "namedRegex": "^/api/admin/pets/(?<nxtPownerId>[^/]+?)/(?<nxtPpetId>[^/]+?)/verify(?:/)?$" }, { "page": "/api/admin/users/clinics/[veterinaryId]", "regex": "^/api/admin/users/clinics/([^/]+?)(?:/)?$", "routeKeys": { "nxtPveterinaryId": "nxtPveterinaryId" }, "namedRegex": "^/api/admin/users/clinics/(?<nxtPveterinaryId>[^/]+?)(?:/)?$" }, { "page": "/api/admin/users/pets/[petId]", "regex": "^/api/admin/users/pets/([^/]+?)(?:/)?$", "routeKeys": { "nxtPpetId": "nxtPpetId" }, "namedRegex": "^/api/admin/users/pets/(?<nxtPpetId>[^/]+?)(?:/)?$" }, { "page": "/api/admin/users/[userId]", "regex": "^/api/admin/users/([^/]+?)(?:/)?$", "routeKeys": { "nxtPuserId": "nxtPuserId" }, "namedRegex": "^/api/admin/users/(?<nxtPuserId>[^/]+?)(?:/)?$" }, { "page": "/api/admin/veterinary/[vetId]/reject", "regex": "^/api/admin/veterinary/([^/]+?)/reject(?:/)?$", "routeKeys": { "nxtPvetId": "nxtPvetId" }, "namedRegex": "^/api/admin/veterinary/(?<nxtPvetId>[^/]+?)/reject(?:/)?$" }, { "page": "/api/admin/veterinary/[vetId]/verify", "regex": "^/api/admin/veterinary/([^/]+?)/verify(?:/)?$", "routeKeys": { "nxtPvetId": "nxtPvetId" }, "namedRegex": "^/api/admin/veterinary/(?<nxtPvetId>[^/]+?)/verify(?:/)?$" }, { "page": "/api/owner/[ownerId]", "regex": "^/api/owner/([^/]+?)(?:/)?$", "routeKeys": { "nxtPownerId": "nxtPownerId" }, "namedRegex": "^/api/owner/(?<nxtPownerId>[^/]+?)(?:/)?$" }, { "page": "/api/owner/[ownerId]/reset-password", "regex": "^/api/owner/([^/]+?)/reset\\-password(?:/)?$", "routeKeys": { "nxtPownerId": "nxtPownerId" }, "namedRegex": "^/api/owner/(?<nxtPownerId>[^/]+?)/reset\\-password(?:/)?$" }, { "page": "/api/pet/[petId]", "regex": "^/api/pet/([^/]+?)(?:/)?$", "routeKeys": { "nxtPpetId": "nxtPpetId" }, "namedRegex": "^/api/pet/(?<nxtPpetId>[^/]+?)(?:/)?$" }, { "page": "/api/veterinary/[clinicId]", "regex": "^/api/veterinary/([^/]+?)(?:/)?$", "routeKeys": { "nxtPclinicId": "nxtPclinicId" }, "namedRegex": "^/api/veterinary/(?<nxtPclinicId>[^/]+?)(?:/)?$" }, { "page": "/api/veterinary/[clinicId]/reset-password", "regex": "^/api/veterinary/([^/]+?)/reset\\-password(?:/)?$", "routeKeys": { "nxtPclinicId": "nxtPclinicId" }, "namedRegex": "^/api/veterinary/(?<nxtPclinicId>[^/]+?)/reset\\-password(?:/)?$" }], "data": { "static": [], "dynamic": [] } }, "locales": [] };
var ConfigHeaders = [];
var PrerenderManifest = { "version": 4, "routes": { "/favicon.ico": { "initialHeaders": { "cache-control": "public, max-age=0, must-revalidate", "content-type": "image/x-icon", "x-next-cache-tags": "_N_T_/layout,_N_T_/favicon.ico/layout,_N_T_/favicon.ico/route,_N_T_/favicon.ico" }, "experimentalBypassFor": [{ "type": "header", "key": "Next-Action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/favicon.ico", "dataRoute": null, "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] } }, "dynamicRoutes": {}, "notFoundRoutes": [], "preview": { "previewModeId": "6164894f6f8ae28be4b159c0b170c647", "previewModeSigningKey": "08e8a8d9b2f0d926a758931588cf3bbb692441c2707316dac960051b6165d309", "previewModeEncryptionKey": "031860f6a7a9da8f657f6feaf894e31cafe64c32177e2dce78f9905bfa8892ae" } };
var MiddlewareManifest = { "version": 3, "middleware": { "/": { "files": ["server/edge-runtime-webpack.js", "server/src/middleware.js"], "name": "src/middleware", "page": "/", "matchers": [{ "regexp": "^(?:\\/(_next\\/data\\/[^/]{1,}))?\\/admin(?:\\/((?:[^\\/#\\?]+?)(?:\\/(?:[^\\/#\\?]+?))*))?(\\.json)?[\\/#\\?]?$", "originalSource": "/admin/:path*" }, { "regexp": "^(?:\\/(_next\\/data\\/[^/]{1,}))?\\/veterinary(?:\\/((?:[^\\/#\\?]+?)(?:\\/(?:[^\\/#\\?]+?))*))?(\\.json)?[\\/#\\?]?$", "originalSource": "/veterinary/:path*" }, { "regexp": "^(?:\\/(_next\\/data\\/[^/]{1,}))?\\/petOwner(?:\\/((?:[^\\/#\\?]+?)(?:\\/(?:[^\\/#\\?]+?))*))?(\\.json)?[\\/#\\?]?$", "originalSource": "/petOwner/:path*" }, { "regexp": "^(?:\\/(_next\\/data\\/[^/]{1,}))?\\/api\\/admin(?:\\/((?:[^\\/#\\?]+?)(?:\\/(?:[^\\/#\\?]+?))*))?(\\.json)?[\\/#\\?]?$", "originalSource": "/api/admin/:path*" }, { "regexp": "^(?:\\/(_next\\/data\\/[^/]{1,}))?\\/api\\/veterinary(?:\\/((?:[^\\/#\\?]+?)(?:\\/(?:[^\\/#\\?]+?))*))?(\\.json)?[\\/#\\?]?$", "originalSource": "/api/veterinary/:path*" }, { "regexp": "^(?:\\/(_next\\/data\\/[^/]{1,}))?\\/api\\/owner(?:\\/((?:[^\\/#\\?]+?)(?:\\/(?:[^\\/#\\?]+?))*))?(\\.json)?[\\/#\\?]?$", "originalSource": "/api/owner/:path*" }, { "regexp": "^(?:\\/(_next\\/data\\/[^/]{1,}))?\\/alogin(\\.json)?[\\/#\\?]?$", "originalSource": "/alogin" }, { "regexp": "^(?:\\/(_next\\/data\\/[^/]{1,}))?\\/vlogin(\\.json)?[\\/#\\?]?$", "originalSource": "/vlogin" }, { "regexp": "^(?:\\/(_next\\/data\\/[^/]{1,}))?\\/pologin(\\.json)?[\\/#\\?]?$", "originalSource": "/pologin" }, { "regexp": "^(?:\\/(_next\\/data\\/[^/]{1,}))?\\/unauthorized(\\.json)?[\\/#\\?]?$", "originalSource": "/unauthorized" }], "wasm": [], "assets": [], "env": { "__NEXT_BUILD_ID": "CDEiWxBtVXq-MrnvDW5dM", "NEXT_SERVER_ACTIONS_ENCRYPTION_KEY": "UPLtc++/tH0lGRVwqkIbjl8Qy7LmnzMJ+m0M9wI9NmY=", "__NEXT_PREVIEW_MODE_ID": "6164894f6f8ae28be4b159c0b170c647", "__NEXT_PREVIEW_MODE_ENCRYPTION_KEY": "031860f6a7a9da8f657f6feaf894e31cafe64c32177e2dce78f9905bfa8892ae", "__NEXT_PREVIEW_MODE_SIGNING_KEY": "08e8a8d9b2f0d926a758931588cf3bbb692441c2707316dac960051b6165d309" } } }, "functions": {}, "sortedMiddleware": ["/"] };
var AppPathRoutesManifest = { "/_not-found/page": "/_not-found", "/api/admin/found-reports/[id]/resolve/route": "/api/admin/found-reports/[id]/resolve", "/api/admin/found-reports/[id]/route": "/api/admin/found-reports/[id]", "/api/admin/dashboard/route": "/api/admin/dashboard", "/api/admin/login/route": "/api/admin/login", "/api/admin/found-reports/route": "/api/admin/found-reports", "/api/admin/lost-reports/[id]/resolve/route": "/api/admin/lost-reports/[id]/resolve", "/api/admin/lost-reports/route": "/api/admin/lost-reports", "/api/admin/lost-reports/[id]/route": "/api/admin/lost-reports/[id]", "/api/admin/pets/[ownerId]/[petId]/reject/route": "/api/admin/pets/[ownerId]/[petId]/reject", "/api/admin/analytics/route": "/api/admin/analytics", "/api/admin/pets/route": "/api/admin/pets", "/api/admin/pets/[ownerId]/[petId]/verify/route": "/api/admin/pets/[ownerId]/[petId]/verify", "/api/admin/users/[userId]/route": "/api/admin/users/[userId]", "/api/admin/users/clinics/[veterinaryId]/route": "/api/admin/users/clinics/[veterinaryId]", "/api/admin/users/route": "/api/admin/users", "/api/admin/users/pets/[petId]/route": "/api/admin/users/pets/[petId]", "/api/admin/veterinary/route": "/api/admin/veterinary", "/api/admin/veterinary/[vetId]/reject/route": "/api/admin/veterinary/[vetId]/reject", "/api/admin/veterinary/[vetId]/verify/route": "/api/admin/veterinary/[vetId]/verify", "/api/auth/forgot-password/route": "/api/auth/forgot-password", "/api/auth/me/route": "/api/auth/me", "/api/auth/reset-password/route": "/api/auth/reset-password", "/api/clinics/route": "/api/clinics", "/api/contacts/route": "/api/contacts", "/api/logout/route": "/api/logout", "/api/maps-coords/route": "/api/maps-coords", "/api/owner/[ownerId]/reset-password/route": "/api/owner/[ownerId]/reset-password", "/api/owner/[ownerId]/route": "/api/owner/[ownerId]", "/api/owner/me/route": "/api/owner/me", "/api/pet/[petId]/route": "/api/pet/[petId]", "/api/pet/login/route": "/api/pet/login", "/api/pet/register/route": "/api/pet/register", "/api/reportFound/route": "/api/reportFound", "/api/reportLost/route": "/api/reportLost", "/api/search/route": "/api/search", "/api/veterinary/[clinicId]/route": "/api/veterinary/[clinicId]", "/api/veterinary/[clinicId]/reset-password/route": "/api/veterinary/[clinicId]/reset-password", "/api/veterinary/login/route": "/api/veterinary/login", "/api/veterinary/me/route": "/api/veterinary/me", "/api/veterinary/register/route": "/api/veterinary/register", "/favicon.ico/route": "/favicon.ico", "/(main)/(auth)/alogin/page": "/alogin", "/(main)/(auth)/pologin/page": "/pologin", "/(main)/(auth)/vlogin/page": "/vlogin", "/(main)/(forgot-reset)/forgot-password/page": "/forgot-password", "/(main)/(forgot-reset)/reset-password/page": "/reset-password", "/(main)/(register)/registerpet/page": "/registerpet", "/(main)/(register)/vetregister/page": "/vetregister", "/(main)/about/page": "/about", "/(main)/contact/page": "/contact", "/(main)/findclinic/page": "/findclinic", "/(main)/lostfound/page": "/lostfound", "/(main)/getpetmicrochipped/page": "/getpetmicrochipped", "/(main)/page": "/", "/(main)/practice/page": "/practice", "/(main)/privacy/page": "/privacy", "/(main)/registersuccesspet/page": "/registersuccesspet", "/(main)/registersuccessvet/page": "/registersuccessvet", "/(main)/search/page": "/search", "/(main)/successstories/page": "/successstories", "/(pannel)/admin/analytics/page": "/admin/analytics", "/(main)/terms/page": "/terms", "/(pannel)/admin/dashboard/page": "/admin/dashboard", "/(pannel)/admin/lost-found/page": "/admin/lost-found", "/(pannel)/admin/manage-users/page": "/admin/manage-users", "/(pannel)/admin/profile/page": "/admin/profile", "/(pannel)/admin/verifications/petOwner/page": "/admin/verifications/petOwner", "/(pannel)/admin/verifications/veterinary/page": "/admin/verifications/veterinary", "/(pannel)/petOwner/dashboard/page": "/petOwner/dashboard", "/(pannel)/petOwner/my-pets/page": "/petOwner/my-pets", "/(pannel)/petOwner/profile/page": "/petOwner/profile", "/(pannel)/petOwner/settings/page": "/petOwner/settings", "/(pannel)/veterinary/dashboard/page": "/veterinary/dashboard", "/(pannel)/veterinary/my-clinic/page": "/veterinary/my-clinic", "/(pannel)/veterinary/profile/page": "/veterinary/profile", "/(pannel)/veterinary/settings/page": "/veterinary/settings" };
